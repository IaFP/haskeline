...
simpleCommand :: (LineState s, Monad m
#if MIN_VERSION_base(4,14,0)
                , Total m
#endif
                 ) => (s -> m (Either Effect s))
...
charCommand :: (LineState s, Monad m
#if MIN_VERSION_base(4,14,0)
              , Total m
#endif
...
changeFromChar :: (LineState t, Monad m
#if MIN_VERSION_base(4,14,0)
       , Total m
#endif
